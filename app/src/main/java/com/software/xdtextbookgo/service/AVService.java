...
public class AVService {
    ...
    //上传书籍修改信息
    public static void upLoadChange(String objectId,AVFile file, String bookName, String author, String publisher, double oriPrice, String dept, String grade,
                                    double price, int count, String xinjiu, SaveCallback saveCallback){

        final AVObject object = new AVObject("SaleInfo");
        object.setObjectId(objectId);
        object.put("picture", file);
        object.put("bookName", bookName);
        object.put("author", author);
